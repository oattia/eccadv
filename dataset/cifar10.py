...
class Cifar10(Dataset):
    ...
    def _set_arrays(self):
        ...
        for i, train_fname in enumerate(self.train_filenames):
            unpickled_train_data = self._unpickle_batch(train_fname)
            ...
            self.labels_train[batch_idx_start:batch_idx_end] = np.array(unpickled_train_data[b"labels"], ndmin=2, dtype=np.int8).T
